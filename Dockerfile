...
RUN apt-key adv --keyserver keyserver.ubuntu.com --recv E1DD270288B4E6030699E45FA1715D88E1DF1F24 \
 ...
 && apt-get update
 RUN DEBIAN_FRONTEND=noninteractive apt-get install -y supervisor logrotate nginx mysql-client postgresql-client \
      imagemagick subversion git cvs bzr mercurial darcs rsync libpq-dev locales openssh-client \
      gcc g++ make patch pkg-config gettext-base libmagickwand-dev imagemagick libc6-dev zlib1g-dev libxml2-dev \
      libmysqlclient18 libpq5 libyaml-0-2 software-properties-common python-software-properties libcurl3 libssl1.0.0 uuid-dev xz-utils \
